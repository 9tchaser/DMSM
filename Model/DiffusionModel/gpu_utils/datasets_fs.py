...
class IXI_dataset:
  def __init__(self,
    ...
    #self.tfr_file_fs_image  = tfr_file_fs_image
  ...
  def train_input_fn(self):
    ...
    dset_fs = tf.data.TFRecordDataset(self.tfr_file_fs_image,compression_type='', buffer_size=self.buffer_mb<<20)
    self.name = 'fs_im'
    dset_fs = dset_fs.map(self._parse_tfrecord_tf, num_parallel_calls=tf.data.experimental.AUTOTUNE)
    dset_fs = dset_fs.take(self.max_images)
    ...
    dset = tf.data.TFRecordDataset.zip((dset_us, dset_mask, dset_fs))
    dset = dset.map(lambda x,y,z: dict(us_im= x["us_im"], mask=y["mask"], fs_im = z["fs_im"]))
...
class fastMRI_dataset:
  ...
  def train_input_fn(self):
    ...
    dset_fs = tf.data.TFRecordDataset(self.tfr_file_fs_image,compression_type='', buffer_size=self.buffer_mb<<20)
    self.name = 'fs_im'
    dset_fs = dset_fs.map(self._parse_tfrecord_tf_3, num_parallel_calls=tf.data.experimental.AUTOTUNE)
    dset_fs = dset_fs.take(self.max_images)
    ...
    dset = tf.data.TFRecordDataset.zip((dset_us, dset_mask, dset_coil_map, dset_fs))
    dset = dset.map(lambda x,y,z,t : dict(us_im=x["us_im"], mask=y["mask"],  coil_map=z["coil_map"], fs_im = t["fs_im"]))
...
def get_dataset(name, *, batch_size, phase='train'):
  ...
  if name == "ixi":
    if phase == 'train':
      ...
      #return IXI_dataset("/home/yuxuan/Dual_SDiff/data/datasets/tfrecords_dataset/test_us/-r08.tfrecords",
      #                   "/home/yuxuan/Dual_SDiff/data/datasets/tfrecords_dataset/test_map/-r08.tfrecords",
      #                   "/home/yuxuan/Dual_SDiff/data/datasets/tfrecords_dataset/test_us/-rxx.labels", batch_size=batch_size)
    ...
    if phase == 'train':
      ...
      return fastMRI_dataset("/home/yuxuan/Dual_SDiff/data/datasets/tfrecords_dataset/fastMRI/ssdiff/ssdiff_train_us/-r09.tfrecords", 
                              ...
                              "/home/yuxuan/Dual_SDiff/data/datasets/tfrecords_dataset/fastMRI/ssdiff/ssdiff_train_fs/ssdiff_train_fs-r09.tfrecords",
                              "/home/yuxuan/Dual_SDiff/data/datasets/tfrecords_dataset/fastMRI/ssdiff/ssdiff_train_us/-rxx.labels", batch_size=batch_size)
    elif phase == 'val':
      return fastMRI_dataset("/home/yuxuan/SSDiffRecon/data/datasets/tfrecords-datasets/fastmri_mixed_val_us_im/-r09.tfrecords", 
                             "/home/yuxuan/SSDiffRecon/data/datasets/tfrecords-datasets/fastmri_mixed_val_mask_im/-r09.tfrecords", 
                             "/home/yuxuan/SSDiffRecon/data/datasets/tfrecords-datasets/fastmri_mixed_val_coil_map_im/-r09.tfrecords", 
                             "/home/yuxuan/SSDiffRecon/data/datasets/tfrecords-datasets/fastmri_mixed_val_us_im/-rxx.labels", batch_size=batch_size)
    elif phase == 'test':
      """ return fastMRI_dataset("/home/yuxuan/Dual_SDiff/data/datasets/tfrecords_dataset/fastMRI/test/FLAIR/test_us_4x/test_us_4x-r09.tfrecords", 
                             ...
                             #"/home/yuxuan/Dual_SDiff/data/datasets/tfrecords_dataset/fastMRI/test/FLAIR/test_fs/test_fs-r09.tfrecords",
